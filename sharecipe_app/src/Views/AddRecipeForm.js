...
const AddRecipeForm = () => {
  ...
  <div>
    <h3>Added Recipe:</h3>
    <ul>
      <li>Title: {addedRecipe.title}</li>
      <li>Category: {addedRecipe.category}</li>
      <li>Ingredients: {addedRecipe.ingredients}</li>
      <li>Preparation Time: {addedRecipe.prepTime} minutes</li>
      <li>Cook Time: {addedRecipe.cookTime} minutes</li>
    </ul>
  </div>
)}
    </div>
